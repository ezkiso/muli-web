...
export default function NicolapsoLayout({
    ...
    return (
        <div className="min-h-screen from-stone-950 via-zinc-950 to-neutral-950">
            {/* 1. StoreSelector - PRIMERO */}
            <StoreSelector currentStoreId="nicolapso" />
            
            {/* 2. Header/Navigation personalizado - SEGUNDO */}
            ...
            {/* Footer */}
            <footer id="about" className="bg-zinc-950 border-t border-zinc-800 mt-20">
